...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/stack_data-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=8751&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/stack_data-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `stack_data` can be installed with:

```
conda install stack_data
```

It is possible to list all of the versions of `stack_data` available on your platform with:
